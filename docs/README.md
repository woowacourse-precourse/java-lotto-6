...
| 발급받은 로또 수량과 번호를 출력 | 오름차순으로 출력                                            |                                                              | 정수 | n개를 구매했습니다.                                          |
| 당첨 번호 6자리를 입력           | 쉼표로 구분 하여 입력                                        | 1. 번호가 공백일 경우<br />2. 콤마로 구분되지 않는 경우      | 정수 | 당첨 번호를 입력해 주세요.                                   |
| 보너스 번호를 입력               |                                                              | 1. 숫자가 아닌 경우 예외처리<br />2. 유효한 숫자를 입력하지 않은 경우 | 정수 | 보너스 번호를 입력해 주세요.                                 |
| 당첨 여부 통계                   | 1. 번호가 몇개가 일치하는지 계산<br />2. 수익률 계산(소수점 둘째자리에서 반올림) |                                                              |  x   | x                                                            |
