...
- [ ] 주어질 수 있는 에러 메시지 들을 저장해 놓는다.
    - [ ] "숫자가 아닌 입력입니다." 예외 메시지를 저장한다.
    - [ ] "입력이 비어있습니다." 예외 메시지를 저장한다.
    - [ ] "구매 금액은 0보다 커야합니다." 예외 메시지를 저장한다.
    - [ ] "구매 금액은 1000원 단위로 입력해야 합니다." 예외 메시지를 저장한다.
    - [ ] "로또 번호는 6개로 구성되어야 합니다." 예외 메시지를 저장한다.
    - [ ] "로또를 구성하는 번호는 1이상 45이하 자연수로 구성되어야 합니다." 예외 메시지를 저장한다.
    - [ ] "로또를 구성하는 6개의 번호는 모두 다른 수로 구성되어야 합니다." 예외 메시지를 저장한다.
    - [ ] "보너스 번호는 6개의 숫자와 다른 숫자로 구성되어야 합니다." 예외 메시지를 저장한다.
- [ ] 해당 에러 메시지를 반환 하도록 한다.
