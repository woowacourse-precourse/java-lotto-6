...
당첨 번호를 수동으로 입력하는 가상의 로또 프로그램입니다.
사용자는 로또 금액을 입력하면 자동으로 금액에 맞는 로또를 발행합니다.
그리고 당첨 번호와 보너스 번호를 입력해 그에 맞는 당첨 통계를 출력합니다.
발행된 구매자의 로또와 당첨 로또 번호를 바탕으로 수익률을 나타내는 프로그램입니다.
