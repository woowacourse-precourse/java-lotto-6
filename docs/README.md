...
- [x] 금액만큼 로또 발행하는 기능.
    - [x] 금액에 따른 로또 구매 가능량 계산해주는 기능 
    - [x] 발행한 로또 수량과 로또 번호를 출력하는 기능
...
- [x] 당첨 번호 6개를 입력 받는 기능.
    ...
    - [x] 입력받은 6개 숫자를 로또로 바꿔주는 기능
- [x] 보너스 번호를 입력 받는 기능.
    - [x] 보너스 번호 입력을 요구하는 출력문 기능
    - [x] 번호가 1~45 사이가 아닐 때 예외 처리
    - [x] 숫자 형식이 아닐 때 예외 처리
    - [x] 중복 숫자일 때 예외 처리
    - [x] 그전에 받은 6개의 숫자와 보너스 번호를 합쳐 당첨 번호로 만들어주는 기능
- [x] 당첨 내역을 출력하는 기능
   - [x] 발행 번호와 당첨 번호를 비교하는 기능
   - [x] 번호 일치 개수에 따라 당첨 순위를 알려주는 기능
   - [x] 당첨 순위에 해당하는 티켓수 누적해주는 기능
- [x] 수익률을 출력해주는 기능
   - [x] 총 당첨 금액을 계산해주는 기능
