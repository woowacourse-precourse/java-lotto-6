...
사용자 입력(raw input)을 검증하는 기능을 하는 함수들을 갖고 있는 클래스입니다.
...
입력 받은 값을 InputValidator를 이용하여 간단한 검증 기능을 수행합니다.
...
출력될 화면을 지속적으로 업데이트하고 렌더링할 수 있습니다.

### 🎮 Controller

#### InputController

InputView에게 사용자 입력을 받는 요청을 합니다.

InputView를 통해 받아온 사용자 입력 값으로 적절한 모델을 생성하는 역할을 합니다.

#### OutputController

OutputView에게 화면을 업데이트할 것을 요청하고 출력하는 기능을 수행합니다.
...
* 인스턴스
    ...
    * 구입한 로또 리스트를 갖고 있습니다.
    * 본인이 구입한 로또 리스트에 대한 당첨 통계 정보를 갖고 있습니다.
* 함수
    * 로또 판매점에서 로또를 구매할 수 있습니다.
    * 당첨 번호와 본인이 구매한 로또 리스트를 비교하여 당첨 통계를 만들 수 있습니다.
...
* 인스턴스
    ...
    * 당첨 번호, 보너스 번호를 토대로 구매한 로또 번호의 당첨 결과 통계 및 수익률을 계산하여 저장하고 있습니다.
