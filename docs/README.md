...
- [ ] 구입 금액 (Amount)
   - [ ] 구입 금액 Valid
     ...
     - [ ] 가격으로 int 형태의 최댓값을 넘거나 음수를 받으면 예외 처리
...
- [x] 로또 (Lotto)
  ...
  - [ ] WinningNumber, BonusNumber를 입력 받아 당첨 여부 계산 및 WinningList 리턴.
...
- [ ] 당첨 번호 (WinningNumber)
  ...
  - [ ] 당첨 번호 Valid
    - [ ] 중복 된 값이 나오면 예외 처리
    - [ ] 공백은 trim 으로 처리
    - [ ] int값이 들어오지 않았을 시 에외 처리
    - [ ] 1 ~ 45 사이의 값이 들어오지 않았을 시 예외 처리
    - [ ] 오름차순으로 정렬되지 않았을 시 에외 처리
    - [ ] 6개 이상의 값이 나오면 예외 처리

- [ ] 보너스 번호 (BonusNumber)
  - [ ] 보너스 번호 생성
  - [ ] 보너스 번호 Valid
    - [ ] 당첨 번호 중 중복된 값이 나오면 예외 처리
    - [ ] 1 ~ 45 사이의 값이 들어오지 않았을 시 예외 처리
    - [ ] int 값이 들어오지 않을 시 예외 처리
...
- [ ] 수익률 (ProfitRate)
  - [ ] 수익률 Valid
    - [ ] double 값이 아니면 예외 처리
    - [ ] 소수점 둘째 자리가 넘으면 예외 처리
    - [ ] 원래 값과 비교하여 반올림 하지 않으면 예외 처리

- [ ] 입력 뷰 (InputView)
  - [ ] 로또 구매 가격 입력 및 컨트롤러로 전송
  - [ ] 당첨 번호 입력 및 컨트롤러로 전송
  - [ ] 보너스 번호 입력 및 컨트롤러로 전송
