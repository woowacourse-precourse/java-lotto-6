...
| 로또 결과        | 맞춘 개수와 보너스 번호 일치 여부에 따른 결과 상태를 가진다 <br/>당첨 결과에 해당하는 상금을 반환다 | 열거형 타입<br/>1등: 6개 번호 일치 / 2,000,000,000원 <br/>2등: 5개 번호 + 보너스 번호 일치 / 30,000,000원<br/> 3등: 5개 번호 일치 / 1,500,000원 <br/>4등: 4개 번호 일치 / 50,000원 <br/>5등: 3개 번호 일치 / 5,000원<br/> 이외는 낙첨 |
