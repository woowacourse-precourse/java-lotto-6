...
- 필요한 기능
    ...
    - [x] **[주어진 설정 요구사항]** : 최솟값이 1, 최댓값이 45이다.

<br>

- 해당 기능과 관련된 예외 상황

    - **[입력값 없음]** : 플레이어가 입력하지 않은 경우
...
- 필요한 기능
    ...
    - [x] **[당첨 번호 입력]** : 당첨 번호를 입력받는다.
    - [x] **[보너스 번호 입력]** : 당첨 번호와 겹치지 않는 보너스 번호를 입력받는다.
...
- 필요한 기능
    ...
    - [x] **[당첨된 로또 상금 합산]** : 당첨된 로또의 당첨 기준에 맞는 상금을 합산한다.
