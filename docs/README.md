...
## 구현할 기능 목록
- [x] 유저로 부터 1,000 단위로 구입 금액을 입력 받는다. InputHandler
  - [ ] 입력값을 검증한다.
    - [ ] [ERROR] 0이 아닌 양의 정수만 입력해야 합니다.
    - [ ] [ERROR] 1,000 단위로 입력해야 합니다.
    - [ ] [ERROR] 1인당 10만원을 초과해서 구매할 수 없습니다.
