...
<img src="flowchart.png" width="800" height="400"/>
...
| 로또 결과        | 맞춘 개수와 보너스 번호 일치 여부에 따른 결과 상태를 가진다 <br/>당첨 결과에 해당하는 상금을 가진다 | 열거형 타입<br/>1등: 6개 번호 일치 / 2,000,000,000원 <br/>2등: 5개 번호 + 보너스 번호 일치 / 30,000,000원<br/> 3등: 5개 번호 일치 / 1,500,000원 <br/>4등: 4개 번호 일치 / 50,000원 <br/>5등: 3개 번호 일치 / 5,000원<br/> 이외는 낙첨 |
...
로또 결과는 맞춘 개수에 대한 인스턴스 변수와 상금을 계산하는 메서드로 구성되어 있다.

| 테스트 내용                          | 입력 예시               | 결과 예시         | 통과 여부 |
|:--------------------------------|:--------------------|:--------------|:-------|
| 맞힌 개수와 보너스 번호 일치 여부에 맞는 결과를 가진다 | (5, true)           | FIRST_PRIZE   | ✔️  |
| 결과에 맞는 상금을 반환한다 | FIRST_PRIZE.prize() | 2_000_000_000 | ✔️           |
...
각각의 메서드를 다음의 방식으로 테스트한다.

| 테스트 내용                          | 입력 예시                                                                                                 | 결과 예시         | 통과 여부 |
|:--------------------------------|:------------------------------------------------------------------------------------------------------|:--------------|:-------|
| 로또 번호와 당첨 번호를 비교해 결과를 반환한다      | 로또 (1,2,3,4,5,7)<br/> (당첨번호, 보너스 번호): ((1,2,3,4,5,6), 7)                                              | SECOND_PRIZE  | ✔️  |
