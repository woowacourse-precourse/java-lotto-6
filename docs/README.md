...
- 보너스 번호를 입력 받는다
  ...
  - [ ] 보너스 번호가 1부터 45 사이의 숫자가 아니라면 IllegalArgumentException을 발생시킨다
  - [ ] 보너스 번호가 1부터 45 사이의 숫자가 아니라면 "[ERROR]"로 시작하는 에러 메시지 내용을 출력한다
  - [ ] 보너스 번호가 1부터 45 사이의 숫자가 아니라면 예외발생 후 종료되지 않는다
  - [ ] 보너스 번호가 당첨 번호에 있으면 IllegalArugmnetException을 발생시킨다 
  - [ ] 보너스 번호가 당첨 번호에 있으면 "[ERROR]"로 시작하는 에러 메시지 내용을 출력한다 
  - [ ] 보너스 번호가 당첨 번호에 있으면 예외 발생 후 종료되지 않는다
