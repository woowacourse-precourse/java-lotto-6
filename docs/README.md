...
- 로또 구입 금액을 입력 받는다 
  ...
  - [X] 로또 구입 금액이 정수(Long)가 아닐 시 IllegalArgumentException을 발생시킨다
  - [X] 로또 구입 금액이 정수(Long)가 아닐 시 "[ERROR]"로 시작하는 에러 메시지 내용을 출력한다
  - [X] 로또 구입 금액이 정수(Long)가 아닐 시 예외를 발생시킨 후 종료되지 않는다
