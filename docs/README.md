...
| 기능종류 | ID               | 기능명         | 설명                                                                                                                                                                                                                                                                                              |
|------|------------------|-------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 입력   | I-01(Input)      | 로또 구입 금액 입력 | 사용자로부터 로또 구입 금액을 1,000원 단위로 입력 받는다.                                                                                                                                                                                                                                                             |
| 입력   | I-02(Input)      | 당첨 번호 입력    | 사용자로부터 로또 당첨 번호를 쉼표(,)를 기준으로 구분하여 입력받는다.                                                                                                                                                                                                                                                        |
| 입력   | I-03(Input)      | 보너스 번호 입력   | 사용자로부터 보너스 번호를 입력받는다.                                                                                                                                                                                                                                                                           |
| 검증   | V-01(Validation) | 로또 구매 금액 검증 | 금액이 1,000 원으로 나누어 떨어지지 않으면 IllegalArgumentException 을 발생시키고 .[ERROR]로 시작하는 에러 메시지를 출력 후 입력을 다시 받는다.                                                                                                                                                                                             |
