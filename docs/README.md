...
- 시뮬레이션이기에 실제 상황과 최대한 유사하게 만들기 위한 장치들이 곳곳에 있다. (ex. 로또 소유자가 당첨금 수령 가능, 당첨 결과 분석 어플, 로또 발행기 등). 이는 아래 부록의 이야기를 읽어보면 자세히 나와있다.
