...
### 출력
- [x] 몇 개를 구입했는지 출력할 수 있다.
- [x] 결과지를 출력할 수 있다.
  - [x] 당첨 통계를 출력할 수 있다.
  - [x] 총 수익률을 출력할 수 있다.
### 로또 게임 진행
#### 구매 프로세스
- [x] 구입 금액 입력 후 금액에 맞는 수량만큼 구입할 수 있다.
#### 당첨 번호 및 보너스 번호 입력 프로세스
- [x] 당첨 번호 및 보너스 번호를 추첨기에 넣을 수 있다.
#### 결과 분석 프로세스
- [x] 구입한 로또에 대한 통계를 알 수 있다.
...
- [x] **당첨 번호**와 **보너스 번호** 입력을 검증할 수 있다.
  ...
  - **당첨 번호**
  - [x] 당첨 번호가 6개의 숫자가 아니면 예외를 발생시킬 수 있다.
  - **보너스 번호**
...
- [x] 총 당첨 금액을 계산할 수 있다.
- [x] 총 수익률을 계산할 수 있다.
- [x] 결과지에 각 당첨 등수 별로 당첨 용지의 개수를 저장할 수 있다.
- [x] 결과지에 총 수익률을 저장할 수 있다.
