...
public enum Exception {
    LOTTO_PURCHASE_UNIT_EXCEPTION("로또 구매 금액은 1,000원 단위로 입력해주세요."),
    LOTTO_PURCHASE_PATTERN_EXCEPTION("로또 구매 금액은 숫자로만 입력할 수 있습니다."),
    LOTTO_SIZE_EXCEPTION("로또 번호는 6개 보다 크거나 작을 수 없습니다."),
    LOTTO_WRONG_NUMBER_EXCEPTION("로또 번호는 1에서 45까지의 숫자로만 입력할 수 있습니다."),
    ...
    RAFFLE_WRONG_INPUT_BONUS_NUMBER_EXCEPTION("보너스 번호는 숫자로만 입력해주세요."),
