...
public class Application {
    public static void main(String[] args) {
        RepositoryDto newDatabase = createNewDatabase();
    ...
    private static RepositoryDto createNewDatabase() {
        return new RepositoryDto(new UserLottoRepository(), new LottoWinningRepository());
    }
}
