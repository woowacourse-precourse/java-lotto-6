...
public class Application {
	...
	private void printResult() {
		System.out.println("\n당첨 통계");
		System.out.println("---");
		System.out.println("3개 일치 (5,000원) - " + rankCnt.get(4) + "개");
		System.out.println("4개 일치 (50,000원) - " + rankCnt.get(3) + "개");
		System.out.println("5개 일치 (1,500,000원) - " + rankCnt.get(2) + "개");
		System.out.println("5개 일치, 보너스 볼 일치 (30,000,000원) - " + rankCnt.get(1) + "개");
