...
public class BonusNumber {
    ...
    private static final String ERROR_RANGE = "[ERROR] 보너스 번호는 1부터 45 사이의 숫자여야 합니다";
    private static final String ERROR_DUPLICATION = "[ERROR] 보너스 번호는 당첨 번호와 달라야 합니다";
    ...
    private void validateRange(int number) {
        if (number < LOTTO_MIN_NUMBER.getLottoProperty() || number > LOTTO_MAX_NUMBER.getLottoProperty()) {
