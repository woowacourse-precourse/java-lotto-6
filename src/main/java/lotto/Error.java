...
public enum Error {
    ...
    TOO_SMALL(String.format("%d보다 작은 수를 입력할 수 없습니다. %d 이상의 수를 입력해주세요.", NumberConstants.MIN_NUMBER)),
    TOO_LARGE(String.format("%d보다 큰 수를 입력할 수 없습니다. %d 이하의 수를 입력해주세요.", NumberConstants.MAX_NUMBER)),
    CONTAINS_DUPLICATE("로또 번호는 서로 중복될 수 없습니다. 서로 중복되지 않게 입력해주세요."),
    NOT_LOTTO_SIZE(String.format("로또 번호의 개수가 %d개가 아닙니다. %개의 번호를 입력해주세요.", NumberConstants.LOTTO_SIZE)),
