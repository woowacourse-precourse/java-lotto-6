...
public enum ErrorMessage {
    ...
    INVALID_BONUS_NUMBER(String.format("[ERROR] 입력한 보너스 번호가 유효하지 않습니다. %d ~ %d 범위의 당첨 번호와 중복되지 않는 숫자를 입력해주세요.",
            LottoConst.MIN_RANGE_NUMBER.getValue(), LottoConst.MAX_RANGE_NUMBER.getValue()));
