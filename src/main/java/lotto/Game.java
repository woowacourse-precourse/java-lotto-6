...
public class Game {
    ...
    private HashMap<Ranking, Integer> result = new HashMap<>();
    ...
    public void calculateProfit(HashMap<Ranking, Integer> result){
        Double sum =0.0;
        ...
        this.profit = Math.round (((sum / this.amount.getMoney()) * 100) * 10.0) / 10.0;
    }
}
