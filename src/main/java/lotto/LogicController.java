...
public class LogicController {
    ...
    public void startGame() {
        ...
        // 구입 금액으로 로또 구입 및 출력
        buyLottoController.buyLottoProcess(purchaseAmount.getPurchaseAmount());
        // 당첨 번호 입력
        inputValueController.inputPrizeNumber();
        // 보너스 번호 입력
        inputValueController.inputBonusNumber();
        // 당첨 결과 계산
        prizeStatisticsController.calculatePrizeStatisticsProcess(lottoBundle, prizeNumber.getPrizeNumber(),
                bonusNumber.getBonusNumber());
        // 총수익률 계산
        earningRateController.calculateEarningRateProcess(purchaseAmount.getPurchaseAmount());
    }
}
