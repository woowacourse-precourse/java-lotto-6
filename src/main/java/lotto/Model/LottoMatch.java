...
public class LottoMatch {
    ...
    public static List<Integer> countMatchingNumbers(List<List<Integer>> totalLottoNumbers,
            List<Integer> winningNumbers, int bonus) {
    ...
    private static int countMatchingNumbersInSingleLotto(List<Integer> lottoNumbers,
            List<Integer> winningNumbers, int bonus) {
        int count = 0;
