...
public class Rule {
    ...
    public static final String OUTPUTWINNING_MESSAGE = "당첨 통계";
    public static final String OUTPUTBONUSMATCH_MESSAGE = "%d개 일치, 보너스 볼 일치 (%s원) - %d개";
    public static final String OUTPUTMATCH_MESSAGE = "%d개 일치 (%s원) - %d개";
    ...
    public static final String DIVIDEMONEY_ERROR = ERROR + "1000원 단위의 금액만 입력할 수 있습니다";
