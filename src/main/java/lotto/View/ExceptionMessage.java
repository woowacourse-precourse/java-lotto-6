...
public class ExceptionMessage {
    ...
    public static final String NOT_NUMBER_RANGE = "[ERROR] 숫자는 " + MIN_NUMBER + "부터 " + MAX_NUMBER + " 사이의 숫자여야 합니다.";
    public static final String NOT_NUMBER_SIZE = "[ERROR] 당첨 번호는 6개 입력 가능합니다.";
    public static final String NOT_NUMBER_OVERLAP = "[ERROR] 중복된 숫자를 입력하셨습니다.";
    public static final String INPUT_TYPE_ERROR = "[ERROR] 숫자만 입력해 주세요.";
    private static final int LOTTO_MIN_AMOUNT = 1000;
    public static final String NOT_NUMBER_ERROR = "[ERROR] 금액은 숫자만 등록 가능합니다.";
