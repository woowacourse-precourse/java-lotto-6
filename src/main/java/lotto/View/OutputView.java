...
public class OutputView {
    ...
    public static void printMatchingCount(List<Integer> matchingCount) {
        ...
        System.out.println("3개 일치 ("
                + df.format(PrizeMoney.FIFTH.getValue()) + "원) - " + matchingCount.get(0) + "개");
        System.out.println("4개 일치 ("
                + df.format(PrizeMoney.FOURTH.getValue()) + "원) - " + matchingCount.get(1) + "개");
        System.out.println("5개 일치 ("
                + df.format(PrizeMoney.THIRD.getValue()) + "원) - " + matchingCount.get(2) + "개");
        System.out.println("5개 일치, 보너스 볼 일치 ("
                + df.format(PrizeMoney.SECOND.getValue()) + "원) - " + matchingCount.get(3) + "개");
        System.out.println("6개 일치 ("
                + df.format(PrizeMoney.FIRST.getValue()) + "원) - " + matchingCount.get(4) + "개");
    }
