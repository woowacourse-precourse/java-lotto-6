...
public class OutputView {
    ...
    public static void printMatchingCount(List<Integer> matchingCount) {
        ...
        System.out.println("5개 일치 (1,500,000원) - " + matchingCount.get(0) + "개");
        System.out.println("5개 일치, 보너스 볼 일치 (30,000,000원) - " + matchingCount.get(0) + "개");
        System.out.println("6개 일치 (2,000,000,000원) - " + matchingCount.get(0) + "개");
    }
}
