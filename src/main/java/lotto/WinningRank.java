...
public enum WinningRank {
    JACKPOT(6, 2_000_000_000, false, "6개 일치 (2,000,000,000)원 - "),
    SECOND_WINNER(5, 30_000_000, true, "5개 일치, 보너스 볼 일치 (30,000,000원) - "),
    THIRD_WINNER(5, 1_500_000, false, "5개 일치 (1,500,000원) - "),
    FOURTH_WINNER(4, 50_000, false, "4개 일치 (50,000원) - "),
    FIFTH_WINNER(3, 5_000, false, "3개 일치 (5,000원) - "),
    NO_LUCK(0, 0, false, null);
