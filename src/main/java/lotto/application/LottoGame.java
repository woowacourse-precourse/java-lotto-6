...
public class LottoGame {
    public  void play() {
        ...
        TicketMachine ticketMachine = TicketMachine.from(money);    // 티켓 머신에게 전달
        ...
        WinNumber winNumber = WinNumber.from(InputView.inputWinNumbers(), InputView.inputBonusNumber());   // 당첨 번호, 보너스 번호 입력
