...
public class BonusNumber {
    ...
    public static final String NOT_INTEGER_ERROR = "보너스 번호는 정수로 입력해야 합니다.";
    public static final String WRONG_RANGER_NUMBER_ERROR = "보너스 번호는 1 ~ 45여아 합니다.";
    public static final String DUPLICATE_BONUS_ERROR = "보너스 번호가 당첨 번호와 중복되었습니다.";
    ...
    private void validateNumberRange(Integer bonus) {
        if (bonus < LottoConstants.MIN_LOTTO_NUMBER || bonus > LottoConstants.MAX_LOTTO_NUMBER) {
            throw new IllegalArgumentException(WRONG_RANGER_NUMBER_ERROR);
        }
    }
