...
public class LottoInputConsole {
    ...
    private static final String READ_MESSAGE_WINNING_LOTTO_NUMBERS = "당첨 번호를 입력해 주세요.";
    private static final String READ_MESSAGE_BONUS_NUMBERS = "보너스 번호를 입력해 주세요.";
    ...
    public String readWinningLottoNumbers() {
        System.out.println(System.lineSeparator() + READ_MESSAGE_WINNING_LOTTO_NUMBERS);
    ...
    public int readBonusNumber() {
        System.out.println(System.lineSeparator() + READ_MESSAGE_BONUS_NUMBERS);
