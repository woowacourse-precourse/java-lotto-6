...
public class ExceptionMessages {
    ...
    public static final String INVALID_NOT_INTEGER = "입력값이 정수가 아닙니다. 공백 없이 숫자와 구분자만 입력하세요";
    ...
    public static final String INVALID_HAS_DUPLICATES = "중복된 번호가 입력되어서는 안됩니다";
