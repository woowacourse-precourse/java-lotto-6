...
public class PrintConst {
    ...
    public static final String FORMAT_LOTTO_PURCHASE = "%d개를 구매했습니다.";
    public static final String FORMAT_LOTTO_NUMBERS = "[%d, %d, %d, %d, %d, %d]";
    public static final String FORMAT_RESULT_AND_COUNT = "%s - %d개";
    ...
    public static final String PREFIX_EXCEPTION = "[ERROR] ";
}
