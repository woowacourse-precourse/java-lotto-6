...
public abstract class ErrorMessage {
    ...
    public static final String ENTER_PROPER_INTEGER = ERROR_HEADER + "올바른 정수 값을 입력해 주세요 (-21억 ~ 21억)";
    public static final String ENTER_PROPER_NATURAL_NUMBER = ERROR_HEADER + "자연수 값을 입력해주세요";
