...
public enum ErrorMessage {
    ...
    WRONG_MINIMUM_BUY(MIN_LOTTO_AMOUNT.getNumber() + "개 이상 구매해야 합니다."),
    WRONG_MAXIMUM_BUY("최대 " + MAX_LOTTO_AMOUNT.getNumber() + "개까지 구매할 수 있습니다."),
    ...
    WRONG_NORMAL_NUMBER_COUNT("로또 번호는 " + NORMAL_NUMBER_COUNT.getNumber() + "개 입력해야 합니다."),
    WRONG_BONUS_NUMBER_COUNT("보너스 번호는 " + BONUS_NUMBER_COUNT.getNumber() + "개 입력해야 합니다."),
    NO_DUPLICATION_ALLOWED("중복되는 번호가 있어서는 안 됩니다."),
    WRONG_NUMBER_RANGE("로또 번호는 " + MIN_NUMBER.getNumber() + "부터 " + MAX_NUMBER.getNumber() + " 사이의 숫자여야 합니다.");
