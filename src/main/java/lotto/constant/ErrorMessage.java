...
public enum ErrorMessage {
    ...
    NOT_IN_NUMBER_RANGE("로또 번호는 " + Constants.NUMBER_MIN_VALUE + "부터 " + Constants.NUMBER_MAX_VALUE + " 사이의 숫자여야 합니다."),
    ...
    private static class Constants {
        ...
        private static final String PRICE_PER_PIECE = df.format(LottoValue
                ...
                .getValue());
        private static final int NUMBER_MIN_VALUE = LottoValue.valueOf("NUMBER_MIN_VALUE").getValue();
        private static final int NUMBER_MAX_VALUE = LottoValue.valueOf("NUMBER_MAX_VALUE").getValue();
