...
public class ExceptionMessage {
    ...
    public static final String REQUIRE_FIVE_COMMAS = String.format("%s \",\" 개수는 %s개여야 합니다.", ERROR, Number.LOTTO_NUM_COUNT-1);
//    public static final String REQUIRE_NOT_CONTINUOUSLY_COMMA = String.format("%s \",\"가 연속되지 않게 입력해야 합니다.", ERROR);
    ...
    public static final String REQUIRE_DIFFERENT_NUMBER_WITH_WINNING_NUMBERS = String.format("%s 당첨번호와 중복되지 않은 값을 입력해주세요.", ERROR);
}
