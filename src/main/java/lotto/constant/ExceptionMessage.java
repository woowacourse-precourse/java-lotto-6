...
public enum ExceptionMessage {
    ...
    REQUIRE_MULTIPLE_OF_LOTTO_PRICE(
            java.lang.String.format("구입 금액은 %s으로 나누어 떨어져야 합니다.", Number.LOTTO_PRICE.getNumber())),
    ...
    REQUIRE_SIX_NUMBERS(java.lang.String.format("숫자 개수는 %s개여야 합니다.", Number.LOTTO_NUM_COUNT.getNumber())),
