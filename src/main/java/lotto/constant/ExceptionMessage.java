...
public class ExceptionMessage {
    ...
    public static final String OUT_OF_RANGE_ERROR_MESSAGE = "1 ~ 45 사이의 숫자만 입력할 수 있습니다.";
    public static final String DIVISION_ERROR_MESSAGE = "1000원으로 나눌 수 있는 금액만 입력 가능합니다.";
    public static final String NO_EMPTY_ERROR_MESSAGE = "공백 혹은 빈문자는 입력할 수 없습니다.";
    public static final String ONLY_NUMBER_MESSAGE = "숫자만 입력할 수 있습니다.";
    public static final String LOTTO_LENGTH_ERROR_MESSAGE = LOTTO_LENGTH + "자리만 입력할 수 있습니다.";
