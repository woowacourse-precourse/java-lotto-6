...
public enum ExceptionMessages {
    ...
    MIN_PURCHASE_AMOUNT_EXCEPTION_MESSAGE("로또 구입 금액은 " + PRICE + " 이상이어야 합니다."),
    PURCHASE_AMOUNT_DIVISIBILITY_EXCEPTION_MESSAGE("로또 구입 금액은 " + PRICE + "로 나누어 떨어져야 합니다."),
    WINNING_NUMBER_COUNT_EXCEPTION_MESSAGE("당첨 번호의 개수는 " + NUMBER_COUNT + "개여야 합니다."),
    WINNING_NUMBER_RANGE_EXCEPTION_MESSAGE("당첨 번호는 " + MIN_NUMBER + " ~ " + MAX_NUMBER + " 사이의 값이어야 합니다."),
