...
public enum ExceptionMessages {
    ...
    PURCHASE_AMOUNT_RANGE_EXCEPTION_MESSAGE("로또 구입 금액은 " + PRICE.getValue() + " 이상이어야 합니다."),
    PURCHASE_AMOUNT_INDIVISIBLE_EXCEPTION_MESSAGE("로또 구입 금액은 " + PRICE.getValue() + "로 나누어 떨어져야 합니다."),
    ...
    WINNING_NUMBER_DUPLICATE_EXCEPTION_MESSAGE("당첨 번호는 중복될 수 없습니다."),
