...
public enum LottoRankExpression {
    ...
    THREE(LottoRank.THREE, "3개 일치 (5,000원) - %d개%n", 1),
    FOUR(LottoRank.FOUR, "4개 일치 (50,000원) - %d개%n", 2),
    FIVE_WITHOUT_BONUS(LottoRank.FIVE_WITHOUT_BONUS, "5개 일치 (1,500,000원) - %d개%n", 3),
    FIVE_WITH_BONUS(LottoRank.FIVE_WITH_BONUS, "5개 일치, 보너스 볼 일치 (30,000,000원) - %d개%n", 4),
    SIX(LottoRank.SIX, "6개 일치 (2,000,000,000원) - %d개%n", 5);
