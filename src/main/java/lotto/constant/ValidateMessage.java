...
public enum ValidateMessage {
    PRICE_CANNOT_BE_NULL_OR_EMPTY("구입 금액은 null 값이거나 빈 값 일 수 없습니다."),
    PRICE_IS_NOT_INTEGER("구입 금액은 정수 값으로 입력해주세요."),
    PRICE_IS_NOT_DIVIDED_1000("구입 금액은 1,000원 단위로 입력해주세요."),
