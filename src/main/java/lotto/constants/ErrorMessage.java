...
public enum ErrorMessage {
    ...
    INVALID_REGEX_INPUT("[ERROR] 입력 형식이 일치하지 않습니다."),
    NOT_INTEGER_INPUT("[ERROR] 정수만 입력 가능합니다."),
    CONTAINS_BLANK_INPUT("[ERROR] 공백이 포함되어 있습니다."),
    INVALID_LOTTO_NUMBERS_SIZE("[ERROR] 로또 번호는 %d개여야 합니다."),
    INVALID_LOTTO_NUMBERS_RANGE("[ERROR] 로또 번호는 %d이상 %d이하여야 합니다."),
    DUPLICATED_LOTTO_NUMBER("[ERROR] 로또 번호는 서로 달라야 합니다."),
    ...
    DUPLICATED_WINNING_NUMBER("[ERROR] 당첨 번호는 서로 달라야 합니다."),
