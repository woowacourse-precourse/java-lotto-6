...
public enum ErrorMessages {
    ...
    WINNING_NUMBERS_COUNT("당첨 번호 개수는 6개여야 합니다."),
    WINNING_NUMBERS_DUPLICATE("당첨 번호는 중복이 될수 없습니다."),
    WINNING_NUMBERS_RANGE("당첨 번호는 1부터 45 사이의 숫자여야 합니다."),
