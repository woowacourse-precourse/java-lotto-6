...
public enum ErrorMessages {
    LLOTTO_PURCHASE_AMOUNT_NOT_NULL("로또 구입 금액에 null 이 될수 없습니다."),
    LLOTTO_PURCHASE_AMOUNT_NUMERIC_ONLY("로또 구입 금액은 숫자여야 합니다."),
    LOTTO_PURCHASE_AMOUNT_POSITIVE_ONLY("로또 구입 금액은 양수만 입력 가능 합니다."),
    LOTTO_PURCHASE_AMOUNT_UNIT("로또 구입금액 단위는 %d원 입니다."),
    LOTTO_PURCHASE_AMOUNT_MAX("최대로 입력할수 있는 로또 구입금액은 %d 입니다."),

    LOTTO_NUMBERS_NOT_NULL("로또 번호는 null 이 될수 없습니다."),
    ...
    BONUS_NUMBER_NOT_NULL("보너스 번호는 null 이 될수 없습니다."),
