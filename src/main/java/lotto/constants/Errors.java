...
public class Errors {
    ...
    public static final String COST_THOUSANDS = ERROR + " 구입 금액은 1,000의 배수여야 합니다.";
    public static final String ANSWER_NUMERIC = ERROR + " 로또 번호는 숫자여야 합니다.";
    public static final String ANSWER_RANGE = ERROR + " 로또 번호는 1부터 45 사이의 숫자여야 합니다.";
    ...
    public static final String BONUS_RANGE = ERROR + " 보너스 번호는 1부터 45 사이의 숫자여야 합니다.";
