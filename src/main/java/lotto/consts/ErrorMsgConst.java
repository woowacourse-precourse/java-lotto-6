...
public class ErrorMsgConst {
    ...
    public static final String ERROR_BONUS_ONLY_NUMBER = "[ERROR] 보너스 숫자는 숫자만 입력 가능합니다.";
    ...
    public static final String ERROR_MONEY_ONLY_NUMBER = "[ERROR] 돈은 숫자만 입력 가능합니다.";
    ...
    public static final String ERROR_WINNUMBER_SPLIT_ONLY_NUMBER = "[ERROR] ,로 구별된 문자들은 숫자만 입력 가능합니다.";
