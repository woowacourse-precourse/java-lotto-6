...
public class Game {
    public void start() {
        ...
        Cash cash = new Cash(purchaseAmount);
        ...
        OutputView.displayLottos(customer.getLottos());
        ...
        WinningRanks winningRanks = new WinningRanks(customer.getLottos(), winningNumbers1);
