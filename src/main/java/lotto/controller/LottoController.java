...
public class LottoController {
    public void run() {
        // 구입 금액 입력 받기
        int budget = Integer.parseInt(InputController.scanBudget());
        ...
        // 당첨 번호 입력 받기
        Lotto winningLottoTicket = userInputToLotto(InputController.scanWinningLottoTicket());

        // 보너스 번호 입력 받기
        int bonusNumber = Integer.parseInt(InputController.scanBonusNumber());
