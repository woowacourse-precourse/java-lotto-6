...
public class LottoController {
	...
	public void start() {
		...
		new LottoTicketListGenerateController().generateLottoTicketList(lottoPurchaseMoney,
			lottoTicketList);
		...
		new LottoWinningStatusCheckingController().checkLottoWinningStatus(lotto, lottoBonus,
			lottoTicketList, lottoWinningStatus);
