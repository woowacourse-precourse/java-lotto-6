...
public class LottoWinningCaseCounter {
	...
	public void countWinningCase(Lotto lotto, LottoBonus lottoBonus, LottoTicketList lottoTicketList, List<Integer> winningCaseCountList) {
		...
		for (LottoTicket lottoTicket : lottoTicketList.getLottoTicketList()){
			LottoWinningCase lottoWinningCase = lottoWinningCaseChecker.checkLottoWinningCase(lotto,lottoBonus,lottoTicket);
...
//			System.out.println(lottoWinningCaseIndex);
//			System.out.println(currentCountOfWinningCase);
			winningCaseCountList.set(lottoWinningCaseIndex, currentCountOfWinningCase + COUNT_STEP.getValue());
		}
	}
}
