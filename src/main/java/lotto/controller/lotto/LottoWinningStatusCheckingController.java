...
public class LottoWinningStatusCheckingController {
	...
	public void checkLottoWinningStatus(Lotto lotto, LottoBonus lottoBonus,
		LottoTicketList lottoTicketList, LottoWinningStatus lottoWinningStatus) {
		List<Integer> winningCaseCountList = INITIAL_LIST;
		new LottoWinningCaseCounter().countWinningCase(lotto, lottoBonus, lottoTicketList,
			winningCaseCountList);
		...
		Double lottoWinningProfit = lottoWinningProfitCalculator.calculateLottoWinningProfit(
			lottoTicketList, winningCaseCountList);
