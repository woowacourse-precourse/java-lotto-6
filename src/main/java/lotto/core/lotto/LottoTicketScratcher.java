...
public class LottoTicketScratcher {
    ...
    public ScratchedLottoTicket scratchTicket(WinningNumbers winningNumbers, BonusNumber bonusNumber,
    ...
    public ScratchedLottoTicketList scratchAllTickets(WinningNumbers winningNumbers, BonusNumber bonusNumber,
