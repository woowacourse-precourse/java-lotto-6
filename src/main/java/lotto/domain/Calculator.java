...
public class Calculator {
    private List<List<Integer>> purchasedLottoTickets = new ArrayList<>();
    ...
    public void requestPurchaseAmount() {
        ...
        issueLottoTickets(numberOfLottoTickets,purchasedLottoTickets);
    }

    private void issueLottoTickets(int numberOfLottoTickets,List<List<Integer>> purchasedLottoTickets) {
        ...
        requestWinnerNumbers();
    }

    private void requestWinnerNumbers() {
    ...
    private void requestBonusNumber() {
        ...
        RecordCalculateResult();
    }

    private void RecordCalculateResult() {
