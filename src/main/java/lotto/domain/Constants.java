...
public class Constants {
    ...
    public static final String LOTTO_PRICE_NOT_POSITIVE_ERROR = "[ERROR] 로또 구입 금액은 양만 입력하세요.\n\n";

    public static final String WINNING_NUMBER_DUPLICATED_ERROR = "[ERROR] 로또 번호는 중복이 될 수 없습니다.";

    public static final String BONUS_NUMBER_DUPLICATED_ERROR = "[ERROR] 보너스 숫자는 로또 번호와 중복이 될 수 없습니다.";
