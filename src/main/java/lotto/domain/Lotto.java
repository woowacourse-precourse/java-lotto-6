...
public class Lotto {
    ...
    public void checkMatch(List<List<Integer>> myList, int bonusNumber) {
        ...
        System.out.println("---");
            System.out.println("3개 일치 (5,000원) - " + winning_check[3] + "개");
            System.out.println("4개 일치 (50,000원) - " + winning_check[4] + "개");
            System.out.println("5개 일치 (1,500,000원) - " + winning_check[5] + "개");
