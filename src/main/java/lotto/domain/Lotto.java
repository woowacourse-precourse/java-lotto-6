...
public class Lotto {
    ...
    private static final String SIZE_ERROR_MESSAGE = "6개의 숫자로만 구성되어 있어야 합니다.";
    private static final String DUPLICATE_ERROR_MESSAGE = "중복되지 않은 숫자로 구성되어 있어야 합니다.";
    private static final String RANGE_ERROR_MESSAGE = "1 ~ 45 범위의 숫자로 구성되어 있어야 합니다.";
    ...
    private void validateSize(List<Integer> numbers) {
        if (numbers.size() != LOTTO_SIZE) {
            throw new InputException(SIZE_ERROR_MESSAGE);
        }
    }
