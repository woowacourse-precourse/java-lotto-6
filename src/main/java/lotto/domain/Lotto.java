...
public class Lotto {
    static final String LOTTO_NUMBER_BOUNDARY_ERROR = "로또번호는 1에서 45 사이여야 합니다.";
    private static final String LOTTO_NUMBER_DUPLICATION_ERROR = "로또 번호는 서로 중복될 수 없습니다.";
    private static final String LOTTO_NUMBERS_COUNT_ERROR = "로또 번호는 6개여야 합니다.";
    ...
    private void validateSizeOfLottoNumbers(List<Integer> numbers) {
        if (numbers.size() != LOTTO_NUMBERS_SIZE) {
            throw new IllegalArgumentException(LOTTO_NUMBERS_COUNT_ERROR);
        }
    }
