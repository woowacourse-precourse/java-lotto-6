...
public class Lotto {
    ...
    public static final String NUMBERS_RANGE_INVALID_EXCEPTION = "로또 번호는 " + LottoGenerator.LOTTO_RANGE_MIN + "부터 " + LottoGenerator.LOTTO_RANGE_MAX + " 사이의 숫자여야 합니다.";
    ...
    private void validateRange(List<Integer> numbers) {
        int validRangeNumber = (int) numbers.stream()
                .filter(n -> LottoGenerator.LOTTO_RANGE_MIN <= n && n <= LottoGenerator.LOTTO_RANGE_MAX)
                .count();
