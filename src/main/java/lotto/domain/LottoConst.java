...
public class LottoConst {
    ...
    public static final String NOT_INPUT_NUM_IN_RANGE = "[ERROR] 번호는 1부터 45까지 숫자 중에서 입력해 주세요.";

    public static final String NOT_INPUT_WINNING_NUMS_NUMBER = "[ERROR] 당첨 번호를 올바르게 입력해 주세요.";
    public static final String NOT_INPUT_BONUS_NUMBER = "[ERROR] 보너스 번호를 올바르게 입력해 주세요.";
