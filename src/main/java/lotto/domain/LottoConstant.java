...
public class LottoConstant {
    ...
    public static final int FIRST_WINNER_HIT_COUNT = 6;
    public static final int SECOND_WINNER_HIT_COUNT = 5;
    public static final int THIRD_WINNER_HIT_COUNT = 5;
    public static final int FORTH_WINNER_HIT_COUNT = 4;
    public static final int FIFTH_WINNER_HIT_COUNT = 3;
