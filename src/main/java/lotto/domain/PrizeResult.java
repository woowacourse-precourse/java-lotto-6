...
public class PrizeResult {
    ...
    public void calcPrizeResult(LottoWinningNumber lottoWinningNumber, Lottos lottos){
        for(Lotto lotto : lottos.getLottos()){
            Prize prize = Prize.getPrize((lotto.getMatchLottoNumber(lottoWinningNumber)),
                    lotto.isContain(lottoWinningNumber.getBonusNumber()));
