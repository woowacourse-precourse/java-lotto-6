...
public enum Rank {
    ...
    private final BiFunction<Integer, Boolean, Boolean> matchResult;

    Rank(final int matchCount, final int prize, final boolean bonus, final BiFunction<Integer, Boolean, Boolean> matchResult){
