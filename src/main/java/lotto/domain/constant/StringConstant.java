...
public class StringConstant {
    ...
    // TEST CASE
    public static final String TEST_STANDARD_EXPENSE = "1000";
    public static final String TEST_STANDARD_WINNINGLOTTO = "1,2,3,4,5,6";
    public static final String TEST_STANDARD_BONUSNUM = "7";
    ...
    public static final String LOTTO_IN_RANGE_ERROR = LOTTO_NUMBER_START + "-" + LOTTO_NUMBER_END + " 사이의 숫자를 입력해주세요.";
    public static final String LOTTO_EXPENSE_NONDIVIDABLE_ERROR = LOTTO_PRICE + "으로 나뉘는 구매 금액을 입력해주세요.";
    public static final String LOTTO_EXPENSE_VALUE_ERROR = MIN_EXPENSE_VALUE + "원 이상의 구매 금액을 입력해주세요.";
        // STATIC
