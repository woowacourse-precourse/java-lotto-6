...
public class LottoService {
    ...
    public double getRateOfReturn(long purchaseAmount, long totalWinningMoney) {
        return round(totalWinningMoney / (double) purchaseAmount * PERCENTAGE_VALUE * MULTIPLIER)
                / MULTIPLIER;
    }
}
