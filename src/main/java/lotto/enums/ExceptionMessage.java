...
public enum ExceptionMessage {
    ...
    LOTTO_SIZE_IS_OVER_SIX("로또 번호의 갯수가 6개보다 많이 입력되었습니다. 6자리로 입력해야 합니다."),
    LOTTO_IS_DUPLICATED("로또 번호가 중복되었습니다. 중복되지 않은 번호를 입력해야 합니다."),
    LOTTO_IS_NOT_BETWEEN_ONE_AND_FORTYFIVE("로또 번호의 범위가 1~45가 아닙니다. 1~45 사이의 번호를 입력해야 합니다."),
    LOTTO_IS_NOT_NUMER("로또 번호가 문자로 입력되었습니다. 로또 번호를 1~45 사이의 숫자를 입력해야 합니다."),
