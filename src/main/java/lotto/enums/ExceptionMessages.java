...
public enum ExceptionMessages {
    ...
    LOTTO_IS_EMPTY("로또 번호가 입력되지 않았습니다. 로또 번호는 1~45 사이의 숫자를 입력해야 합니다."),
    BONUS_NUMBER_IS_NOT_BETWEEN_ONE_AND_FORTYFIVE("보너스 번호의 범위가 1~45가 아닙니다. 1~45 사이의 번호를 입력해야합니다."),
    BONUS_NUMBER_IS_NOT_NUMBER("보너스 번호가 숫자가 아닙니다. 보너스 번호는 1~45사이의 숫자를 입력해야합니다."),
    BONUS_NUMBER_IS_EMPTY("보너스 번호가 입력되지 않았습니다. 보너스 번호는 1~45사이의 숫자를 입력해야합니다."),
    BONUS_NUMBER_IS_DUPLICATED_WINNING_NUMBER("보너스 번호가 당첨 번호와 중복됩니다. 중복되지 않는 숫자를 입려해야합니다.");
