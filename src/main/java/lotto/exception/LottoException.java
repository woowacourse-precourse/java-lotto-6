...
public class LottoException extends IllegalArgumentException {
    public enum ErrorMessage {
        LOTTO_MIN_AMOUNT("숫자를 입력해 주세요. 로또 한장 금액은 " + LOTTO_PRICE.getValue() +"원 입니다."),
        RANGE_LOTTO_NUMBER("로또 번호는 1부터 45 사이의 숫자여야 합니다."),
        DUPLICATE_LOTTO_NUMBERS("1부터 45 사이의 중복되지 않는 숫자 6개를 입력해주세요." + LINE.getMessage() +
                "양식: \"1,7,13,24,42,45\""),
        RANGE_BONUS_NUMBER("보너스 번호는 1부터 45 사이의 숫자여야 합니다."),
        ...
        ALREADY_CONTAINS_BONUS_NUMBER("입력하신 보너스 번호는 이미 로또에 포함되어 있습니다.");
