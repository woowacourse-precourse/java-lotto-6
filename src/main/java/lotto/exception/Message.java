...
public class Message {
    ...
    public static final String INPUT_LOTTO_NUMBERS_ERROR = "[ERROR] 로또 번호가 잘못되었습니다. 번호를 다시 입력해주세요!";
    public static final String INPUT_BONUS_NUMBERS_ERROR = "[ERROR] 보너스 번호가 잘못되었습니다. 번호를 다시 입력해주세요!";
}
