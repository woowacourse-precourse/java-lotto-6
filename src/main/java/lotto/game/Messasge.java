...
public class Messasge {
    ...
    public static String getResultMessage(Map<Rank, Integer> result, double profitRate){
        ...
        message.append(String.format("%d개 일치 (%,d원) - %d개", Rank.FIFTH.getCount(), Rank.FIFTH.getReward(), result.get(Rank.FIFTH))).append("\n");
        message.append(String.format("%d개 일치 (%,d원) - %d개", Rank.FOURTH.getCount(), Rank.FOURTH.getReward(), result.get(Rank.FOURTH))).append("\n");
        message.append(String.format("%d개 일치 (%,d원) - %d개", Rank.THIRD.getCount(), Rank.THIRD.getReward(), result.get(Rank.THIRD))).append("\n");
        message.append(String.format("%d개 일치, 보너스 볼 일치 (%,d원) - %d개", Rank.SECOND.getCount(), Rank.SECOND.getReward(), result.get(Rank.SECOND))).append("\n");
        message.append(String.format("%d개 일치 (%,d원) - %d개", Rank.FIRST.getCount(), Rank.FIRST.getReward(), result.get(Rank.FIRST))).append("\n");
