...
public enum ErrorMessage {
    ...
    INPUT_IS_NOT_NUMBER("[ERROR] 입력한 값이 (0-9)로 이루어진 숫자가 아닙니다."),
    INPUT_IS_NOT_AVAILABLE_LENGTH("[ERROR] 입력한 숫자의 개수가 당첨 로또 길이에 적합하지 않습니다."),

    INVALID_LOTTO_NUMBER_RANGE("[ERROR] 입력한 숫자가 로또 번호 범위를 벗어납니다."),
