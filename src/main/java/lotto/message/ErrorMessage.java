...
public enum ErrorMessage {
    ...
    ERROR_NOT_NUMERIC_VALUE("[ERROR] 숫자로만 이루어진 값을 입력해야 합니다.\n"),
    ERROR_INDIVISIBLE_BY_1000("[ERROR] 1,000원 단위의 금액을 입력해야 합니다.\n"),
    ...
    ERROR_CONTAIN_BONUS_NUMBER_IN_WINNING_NUMBER("[Error] 당첨 번호에 포함되지 않은 숫자를 입력해야 합니다."),
    ;
