...
public enum Error {
    ...
    NOT_NUMERIC_PURCHASE_PRICE("[ERROR] 구입 금액은 양의 숫자이어야 합니다."),
    NOT_NUMERIC_WINNING_NUMBER("[ERROR] 당첨 번호는 양의 숫자이어야 합니다."),
    ...
    NOT_NUMERIC_BONUS_NUMBER("[ERROR] 보너스 번호는 양의 숫자이어야 합니다."),
