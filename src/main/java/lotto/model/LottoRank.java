...
public enum LottoRank {
    THREE_MATCHES(MATCH_COUNT_THREE, 5000),
    FOUR_MATCHES(MATCH_COUNT_FOUR, 50000),
    FIVE_MATCHES(MATCH_COUNT_FIVE, 1500000),
    FIVE_MATCHES_WITH_BONUS(MATCH_COUNT_FIVE, 30000000),
    SIX_MATCHES(MATCH_COUNT_SIX, 2000000000);
