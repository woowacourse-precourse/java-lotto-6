...
public class ProfitRate {
    ...
    public static ProfitRate from(final Map<LottoRank, Integer> result, BuyAmount buyAmount) {
        return new ProfitRate(calculateRateOfProfit(result, buyAmount));
    }

    public static Double calculateRateOfProfit(final Map<LottoRank, Integer> result, BuyAmount buyAmount) {
