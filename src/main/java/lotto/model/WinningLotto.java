...
public class WinningLotto {
    ...
    private static final String INVALID_BONUS_NUMBER_RANGE_ERROR = "[ERROR] 보너스 번호는 %d~%d 사이의 수여야 합니다.";
    ...
    private int validateNotNumber(String bonusNumberStr) {
        try {
            ...
            throw new IllegalArgumentException(NOT_NUMBER_BONUS_NUMBER_ERROR);
        }
    }
