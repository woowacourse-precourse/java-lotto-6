...
public class WinningNumbers {
    ...
    private static final String WINNING_NUMBERS_SIZE_ERROR_MESSAGE = "[ERROR] 당첨 번호는 6개여야 합니다.";
    private static final String WINNING_NUMBERS_DUPLICATE_ERROR_MESSAGE = "[ERROR] 당첨 번호는 중복되는 값이 존재하지 않아야 합니다.";
    private static final String WINNING_NUMBERS_RANGE_ERROR_MESSAGE = "[ERROR] 당첨 번호는 1부터 45까지의 숫자여야 합니다.";
