...
public enum LottoWinningCase {
	...
	LottoWinningCase(int sameNumberCount, boolean bonusBallExsistence, int winningMoney,
	...
	public static LottoWinningCase findWinningCaseByValue(int countedValueOfLottoSameNumber,
		Boolean comparedValueOfLottoBonusNumber, int counterForInterate) {
		...
		if (currentLottoWinningCaseSameNumberCount == countedValueOfLottoSameNumber
			&& currentLottoWinningCaseBonusBallExsistence == comparedValueOfLottoBonusNumber) {
		...
		return findWinningCaseByValue(countedValueOfLottoSameNumber,
