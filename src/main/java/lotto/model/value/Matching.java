...
public enum Matching {
    ...
    FIVE_BONUS("5개 일치, 보너스 볼 일치", "30,000,000원", 30000000, "5-1"),
    SIX("6개 일치", "2,000,000,000원", 2000000000, "6");

    private static final Map<String, String> matchingMap = Collections.unmodifiableMap(
    ...
    Matching(String matchingNumber, String prizeMoney, int money, String count) {
    ...
    public static Matching of(final String count) {
