...
public class LottoResultService {
    ...
    private Map<LottoInformation, Integer> countOfWinning = new HashMap<>();

    public void lottoResult(User user, Lotto lotto) {
    ...
    public void winLotto(int value, User user) {
        inputCountOfWinning(LottoInformation.FIND.valueOf(value));
        user.addWinningPrice(LottoInformation.FIND.valueOf(value).getPrice());
    }
    ...
    public void inputCountOfWinning(LottoInformation lottoInformation) {
        countOfWinning.put(lottoInformation, countOfWinning.getOrDefault(lottoInformation, 0) + 1);
    }
