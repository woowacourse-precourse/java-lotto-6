...
public class ExceptionHandler {
    ...
    private static final String WINNING_NUMBER_IS_NOT_6_LENGTH = "[ERROR] 로또 번호의 길이는 6글자여야 합니다.";
    ...
    public static void throwWinningNumberLengthException() {
        throw new IllegalArgumentException(WINNING_NUMBER_IS_NOT_6_LENGTH);
    }
}
