...
public enum ErrorMessage {
    ...
    INPUT_COMMA_ERROR("[ERROR] 입력 형식이 올바르지 않습니다. 입력은 공백 없이 쉼표(,)로 구분 해주세요."),
    UNIQUE_NUMBER_ERROR("[ERROR] 중복된 숫자가 있습니다. 확인 후 다시 시도 해주세요."),
    UNIQUE_BONUS_ERROR("[ERROR] 보너스 번호는 당첨 번호와 중복되어서는 안됩니다. 확인 후 다시 시도 해주세요.");
