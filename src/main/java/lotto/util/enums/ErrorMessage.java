...
public enum ErrorMessage {
    ...
    NUMBER_CANNOT_BE_NULL("번호는 NULL이 될 수 없습니다."),
    NUMBER_CANNOT_BE_NEGATIVE("번호에 0 또는 음수가 포함될 수 없습니다."),
    NUMBER_CANNOT_BE_EMPTY("입력 번호가 비어있습니다."),
    NUMBER_GREATER_THAN_45("입력된 값은 45보다 클 수 없습니다."),

    AMOUNT_CANNOT_BE_LESS_THAN_ZERO("입력된 값은 0보다 작을 수 없습니다."),
