...
public enum ErrorMessageConstant {
    ...
    PARCHASE_AMOUNT_IS_NOT_NUMERIC("구매 금액은 숫자여야 합니다"),
    PARCHASE_AMOUNT_IS_NOT_DIVISIBLE_BY_THOUSAND("구매 금액은 1000으로 나누어 떨어져야 합니다."),
    PARCHASE_AMOUNT_IS_NOT_POSITIVE_NUMBER("구매 금액은 양수여야합니다.");
