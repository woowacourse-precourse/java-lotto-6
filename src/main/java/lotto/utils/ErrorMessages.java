...
public class ErrorMessages {
    ...
    public static final String NO_PURCHASE_AMOUNT = PREFIX + "구입 금액은 0보다 작거나 같을 수 없습니다.";
    public static final String TOO_MUCH_PURCHASE_AMOUNT = PREFIX + "최대로 구입 가능한 로또 개수는 %d개 입니다. 구입 금액을 낮춰주세요.";
