...
import static lotto.utils.LottoSystemUtils.MONEY_MAX_RANGE;
import static lotto.utils.LottoSystemUtils.MONEY_MIN_RANGE;
...
public class ErrorPhrase {
    ...
    public static final String ERROR_PHRASE_MONEY_IS_WRONG_UNIT = "구입 금액은 1000원 단위만 가능합니다.";
