...
public class ErrorMessageConstants {
    ...
    public static final String PURCHASE_AMOUNT_FORMAT_ERROR_MESSAGE = "1000이상 100000이하의 숫자만 입력해주세요";
    public static final String WINNING_NUMBER_FORMAT_ERROR_MESSAGE = "1이상 45이하의 숫자만 입력해주세요";
    ...
    public static final String PICK_NUMBER_ERROR = "6개를 입력해주세요";
