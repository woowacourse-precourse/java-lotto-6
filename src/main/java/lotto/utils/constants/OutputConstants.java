...
public class OutputConstants {
    ...
    public static final String SECOND_PRIZE = "5개 일치 (1,500,000원) - ";
    public static final String SECOND_PRIZE_BONUS_NOT_CORRECT = "5개 일치, 보너스 볼 일치 (30,000,000원) - ";
    public static final String FIRST_PRIZE_MONEY = "6개 일치 (2,000,000,000원) - ";
    public static final String EARN_RATE_MESSAGE = "총 수익률은 ";
