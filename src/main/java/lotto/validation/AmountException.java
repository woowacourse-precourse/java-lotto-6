...
public enum AmountException {
    ...
    LEAST_VALUE_EXCEPTION(new IllegalArgumentException("[ERROR] 구입 금액은 최소 1,000원 부터 입니다.")),
    MOST_VALUE_EXCEPTION(new IllegalArgumentException("[ERROR] 구입 금액은 최대 100,000원까지 입니다.")),
