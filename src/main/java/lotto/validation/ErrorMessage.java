...
public enum ErrorMessage {
	ERROR_INPUT_SIZE("[ERROR] 6개의 숫자를 입력해 주세요."),
	ERROR_RANGE("[ERROR] 1-45의 숫자를 입력해 주세요."),
	...
	ERROR_PURCHASE_LIMIT("[ERROR] 구입 금액은 1,000이상 100000이하여야 합니다."),
	ERROR_IS_NUMBER("[ERROR] 숫자를 입력해 주세요."),
