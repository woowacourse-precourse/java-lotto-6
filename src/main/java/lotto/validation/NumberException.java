...
public enum NumberException {
    ...
    OUT_RANGE_RANGE_EXCEPTION(new IllegalArgumentException("[ERROR] 번호는 1 이상 45이하의 수만 입력할 수 있습니다.")),
    ...
    LIMIT_NUMBER_EXCEPTION(new IllegalArgumentException("[ERROR] 너무 큰 수를 입력할 수 없습니다."));
