...
public class MoneyValidator {
    private static final String ERROR_ZERO = "[ERROR] 금액은 0일 수 없습니다.";
    private static final String ERROR_DIVIDE = "[ERROR] 금액은 1000으로 나누어지는 수 입니다.";
    private static final String ERROR_FORMAT = "[ERROR] 금액에 숫자가 아닌 문자가 올 수 없습니다.";
