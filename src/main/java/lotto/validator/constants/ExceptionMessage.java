...
public enum ExceptionMessage {
    ...
    PAY_AMOUNT_DIGIT_ERROR("[ERROR] 구매금액은 최대 10자리의 수만 입력 가능합니다."),
    ...
    WINNING_NUMBERS_SIZE_ERROR("[ERROR] 당첨번호는 6개의 숫자로 입력해 주세요."),
    ...
    BONUS_NUMBERS_RANGE_ERROR("[ERROR] 보너스 번호는 1에서 45사이의 숫자로 입력해 주세요."),
