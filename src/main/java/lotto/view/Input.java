...
public class Input {
    public static String USER_PURCHASE_PRICE_INPUT = "구입금액을 입력해 주세요.";
    public static String WINNING_NUMBERS_INPUT = "당첨 번호를 입력해 주세요.";
    public static String WINNING_BONUS_NUMBER_INPUT = "보너스 번호를 입력해 주세요.";
