...
public class LottoConstants {
    ...
    public static final String MSG_PURCHASE_COUNT_PROMPT = "%d개를 구매했습니다.";
    ...
    public static final String MSG_WINNING_STATUS_HEADER = "당첨 통계";
    public static final String MSG_WINNING_STATUS_DIVIDER = "---";
    public static final String FORMAT_WINNING_STATUS = "%d개 일치 (%d원) - %d개";
    public static final String FORMAT_RATE_OF_RETURN = "총 수익률은 %d%%입니다.";
}
