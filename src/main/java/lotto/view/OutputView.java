...
public class OutputView {
    ...
    public static final String STATISTICS_FORMAT = "당첨 통계\n---\n%s";
    ...
    public OutputView() {
        ...
        winningStatisticsText = STATISTICS_FORMAT;
    ...
    public void renderStatisticsText() {
    ...
    public void updateStatisticsText(String winningStatistics) {
        winningStatisticsText = String.format(STATISTICS_FORMAT, winningStatistics);
    }
