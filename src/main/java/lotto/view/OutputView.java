...
public final class OutputView {
    ...
    public static void printMyLotto(final long count) {
    ...
    public static void printLotto(final List<Integer> lotto) {
    ...
    public static void printReward(final List<ResultLotto> result) {
        System.out.println();
        printMessage("당첨 통계");
        printMessage("---");
    ...
    public static void printYield(final float yield) {
