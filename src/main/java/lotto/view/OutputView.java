...
public class OutputView {
    ...
    public static final String PRINT_RESULT_MESSAGE = "총 수익률은 %s%%입니다.";
    ...
    public void printWinningState(int[] prizeGradeCounts) {
        ...
        System.out.printf(GRADE_4_MATCH_MESSAGE, GRADE_4_MATCH, prizeGradeCounts[4]);
        System.out.printf(GRADE_5_MATCH_MESSAGE, GRADE_5_MATCH, prizeGradeCounts[3]);
        System.out.printf(GRADE_5_MATCH_WITH_BONUS_MESSAGE, GRADE_5_MATCH_WITH_BONUS, prizeGradeCounts[2]);
        System.out.printf(GRADE_6_MATCH_MESSAGE, GRADE_6_MATCH, prizeGradeCounts[1]);
    }

    public void printRevenueRate(double revenueRate) {
        String revenueRateOutput = String.format("%.1f", revenueRate);
        System.out.printf(PRINT_RESULT_MESSAGE,revenueRateOutput);
    }
}
