...
public class OutputView {
    ...
    private static final LinkedHashMap<LotteryResultState, String> OUTPUT_RESULT_MESSAGE_BY_STATE = new LinkedHashMap<>();

    static {
        OUTPUT_RESULT_MESSAGE_BY_STATE.put(LotteryResultState.THREE_MATCH, "3개 일치 (5,000원) - %d개");
        OUTPUT_RESULT_MESSAGE_BY_STATE.put(LotteryResultState.FOUR_MATCH, "4개 일치 (50,000원) - %d개");
        OUTPUT_RESULT_MESSAGE_BY_STATE.put(LotteryResultState.FIVE_MATCH_NO_BONUS, "5개 일치 (1,500,000원) - %d개");
        OUTPUT_RESULT_MESSAGE_BY_STATE.put(LotteryResultState.FIVE_MATCH_BONUS, "5개 일치, 보너스 볼 일치 (30,000,000원) - %d개");
        OUTPUT_RESULT_MESSAGE_BY_STATE.put(LotteryResultState.SIX_MATCH, "6개 일치 (2,000,000,000원) - %d개");
    }
    ...
    public static void outputResult(HashMap<LotteryResultState, Integer> result) {
