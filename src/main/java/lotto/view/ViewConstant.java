...
public class ViewConstant {
    static class InputViewConstant {
        static final String COMMA = ",";
        static final String NUMBERS_FORMAT_REGEX = "([0-9]+,?)+";
        static final String NUMBER_REGEX = "[0-9]+";
        static final long ONE_LOTTO_PRICE = 1000L;
    ...
    static class OutputViewConstant {
        static final String PURCHASE_AMOUNT_MESSAGE = "구입금액을 입력해 주세요.";
        static final String WINNING_NUMBER_MESSAGE = "당첨 번호를 입력해 주세요.";
        static final String BONUS_NUMBER_MESSAGE = "보너스 번호를 입력해 주세요.";
        static final String EARNING_RATE_MESSAGE = "총 수익률은 %.1f%%입니다.";
        static final String PURCHASE_MESSAGE = "%d개를 구매했습니다.";
        static final String STATUS = "당첨 통계";
        static final String THREE_DASH = "---";
