...
public class Exception {
    public static final String COST_MOD = "[ERROR] 1000원 단위로 입력해주세요.";
    public static final String COST_FORMAT = "[ERROR] 20억 이하의 숫자를 입력해주세요.";
    public static final String LOTTO_FORMAT = "[ERROR] 로또 번호는 숫자여야 합니다.";
    ...
    public static final String LOTTO_RANGE = "[ERROR] 로또 번호는 1에서 45 사이의 숫자여야 합니다.";
    public static final String BONUS_FORMAT = "[ERROR] 보너스 번호는 숫자여야 합니다.";
