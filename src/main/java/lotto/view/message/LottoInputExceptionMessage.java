...
public enum LottoInputExceptionMessage {
    ...
    WINNING_LOTTO_NUMBERS_DOES_NOT_CONTAIN_DELIMITER(OutputConstant.ERROR_WARNING + "당첨번호는" + InputConstant.COMMA_SYMBOL + "(" + InputConstant.WINNING_LOTTO_NUMBERS_DELIMITER + ")를 기준으로 입력해주셔야 합니다." + OutputConstant.NEW_LINE),
    ...
    WINNING_LOTTO_NUMBERS_ENDS_WITH_DELIMITER(OutputConstant.ERROR_WARNING + "입력된 당첨번호가" + InputConstant.COMMA_SYMBOL +"(" + InputConstant.WINNING_LOTTO_NUMBERS_DELIMITER +")로 끝납니다." + OutputConstant.NEW_LINE);
