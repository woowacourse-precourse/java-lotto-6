...
class ApplicationTest extends NsTest {
    ...
    void 예외_테스트_금액_매우큰수() {
        assertSimpleTest(() -> {
            runException("1000000000000000000000000");
            assertThat(output()).contains(ERROR_MESSAGE);
        });
    }

    @Test
    void 예외_테스트_금액_1000의배수X() {
        assertSimpleTest(() -> {
            runException("1987");
            assertThat(output()).contains(ERROR_MESSAGE);
        });
