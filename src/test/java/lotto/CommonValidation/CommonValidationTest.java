...
import static lotto.CommonValidation.CommonValidation.isValidNumberRange;
...
class CommonValidationTest {
    ...
    void isValidRangeTest2() {
        ...
        //when
        isValidNumberRange(value1);
        isValidNumberRange(value2);
