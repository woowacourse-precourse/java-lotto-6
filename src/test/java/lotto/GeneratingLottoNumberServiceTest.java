...
class GeneratingLottoNumberServiceTest {
    private static GeneratingLottoNumberService generateLottoNumbers = new GeneratingLottoNumberService();
    ...
    public void getBuyingQuantityTest() {
        ...
        // when
        int result = generateLottoNumbers.getBuyingLottoTicket(buyingPrice);
