...
public class LottoDataTest {
    ...
    void 당첨_번호_입력_검증_통과() {
        ...
        assertThatNoException().isThrownBy(() -> new LottoData(new Lotto(input),  new BonusNumber(bonusNumber)));
    }
    ...
    void 당첨_번호_입력_검증_실패_중복_숫자() {
        ...
        assertThatThrownBy(() -> new LottoData(new Lotto(input), new BonusNumber(bonusNumber)))
