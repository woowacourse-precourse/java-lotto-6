...
class LottoGameTest {
    ...
    void input_WinningNumbers_함수에서_당첨번호_조건에_맞에_입력하면_그대로_출력() {
        try (MockedStatic<Console> mock = Mockito.mockStatic(Console.class)) {
            //given
    ...
    void input_WinningNumbers_함수에서_당첨번호를_5개_입력받은_경우_IllegalArgumentException에러_발생() {
        try (MockedStatic<Console> mock = Mockito.mockStatic(Console.class)) {
            //given
    ...
    void input_WinningNumbers_함수에서_당첨번호를_7개_입력받은_경우_IllegalArgumentException에러_발생() {
        try (MockedStatic<Console> mock = Mockito.mockStatic(Console.class)) {
            //given
    ...
    void input_WinningNumbers_함수에서_당첨번호를_1에서_45사이의_숫자를_입력하지_않은_경우_IllegalArgumentException에러_발생() {
        try (MockedStatic<Console> mock = Mockito.mockStatic(Console.class)) {
            //given
    ...
    void input_WinningNumbers_함수에서_당첨번호에_중복된_숫자를_입력할_경우_IllegalArgumentException에러_발생() {
        try (MockedStatic<Console> mock = Mockito.mockStatic(Console.class)) {
            //given
