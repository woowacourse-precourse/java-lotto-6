...
import lotto.util.LottoNumberSelector;
import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Test;

public class LottoNumberSelectorTest {
    private static LottoNumberSelector lottoNumberSelector = new LottoNumberSelector();
    ...
    public void getBuyingQuantityTest() {
        ...
        // when
        int result = lottoNumberSelector.getBuyingQuantity(buyingPrice);
    ...
    public void sortedListTest() {
        ...
        // when
        sortedList = lottoNumberSelector.sortedList(unsortedList);
    ...
    public void buyingLottosTest() {
        ...
        // when
        lottos = lottoNumberSelector.buyingLottos(quantity);
