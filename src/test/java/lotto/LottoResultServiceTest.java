...
public class LottoResultServiceTest {
    ...
    public void getYieldOfLottoTest() {
        ...
        // when
        String result = lottoResultService.getYieldOfLotto(user, totalPrice);
    ...
    public void countUserNumbersContainLottoTest() {
        ...
        // when
        int count = lottoResultService.countUserNumbersContainLotto(userNumbers, lottoNumbers);
    ...
    public void isNumberMatchedNormalTest() {
        ...
        // when
        boolean result1 = lottoResultService.isNumberMatchedNormal(countContainsOfLotto1);
        boolean result2 = lottoResultService.isNumberMatchedNormal(countContainsOfLotto2);
        boolean result3 = lottoResultService.isNumberMatchedNormal(countContainsOfLotto3);
        boolean result4 = lottoResultService.isNumberMatchedNormal(countContainsOfLotto4);
    ...
    public void isNumberMatchedFiveWithBonusTest() {
        ...
        // when
        boolean result = lottoResultService.isNumberMatchedFiveWithBonus(countContainsOfLotto, numbers, lotto);
    ...
    public void isNumberMatchedFiveTest() {
        ...
        // when
        boolean result = lottoResultService.isNumberMatchedFive(countContainsOfLotto, numbers, lotto);
