...
class LottoTest {
    ...
    void duplicationCheck() {
    	IllegalArgumentException exception=assertThrows(IllegalArgumentException.class, () -> number.forMyTest(DUPLICATED_VALUES));
    ...
    @Test
    void moreThanSize() {
    	IllegalArgumentException exception=assertThrows(IllegalArgumentException.class, () -> number.forMyTest(MORE_THAN_SIZE));
    ...
    @Test
    void lessThanSize() {
    	IllegalArgumentException exception=assertThrows(IllegalArgumentException.class, () -> number.forMyTest(LESS_THAN_SIZE));
    	assertEquals("[ERROR] 6개의 번호만 유효합니다", exception.getMessage());
    }
    ...
    @Test
    void onlyInteger() {
    	IllegalArgumentException exception=assertThrows(IllegalArgumentException.class, () -> number.forMyTest(DOUBLE_INPUT));
    ...
    @Test
    void emptyNum() {
    	IllegalArgumentException exception=assertThrows(IllegalArgumentException.class, () -> number.forMyTest(EMPTY_NUM));
    	assertEquals("[ERROR] 번호는 정수인 숫자만 유효합니다(공백 불가)", exception.getMessage());
    }
    ...
    @Test
    void naN() {
    	IllegalArgumentException exception=assertThrows(IllegalArgumentException.class, () -> number.forMyTest(NFE));
    	assertEquals("[ERROR] 번호는 정수인 숫자만 유효합니다(공백 불가)", exception.getMessage());
    }
