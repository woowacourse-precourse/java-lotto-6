...
class LottoTest {
    ...
    void createLottoByOverSize() {
        ...
        assertEquals(exception.getMessage(), "6개의 숫자가 아닙니다.");
        Exception exception2 = assertThrows(IllegalArgumentException.class, () -> new Lotto(List.of(1, 2, 3, 4, 5)));
        assertEquals(exception2.getMessage(), "6개의 숫자가 아닙니다.");
    }
    ...
    void createLottoByDuplicatedNumber() {
        ...
        assertEquals(exception.getMessage(), "중복된 숫자가 있습니다.");
    }
    ...
    void creatLottoBy1to45(){
        ...
        assertEquals(exception.getMessage(), "1에서 45사이의 수가 아닙니다.");
        Exception exception2 = assertThrows(IllegalArgumentException.class, () -> new Lotto(List.of(-1, 2, 3, 4, 5, 11)));
        assertEquals(exception2.getMessage(), "1에서 45사이의 수가 아닙니다.");
    }
