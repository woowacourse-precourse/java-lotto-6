...
public class ValidateWinningLottoNumbersTest {
    ...
    void 당첨번호_검증_정상처리(String winningLottoNumbers) {
        assertThatCode(() -> LottoValidator.validateWinningLottoNumbers(winningLottoNumbers))
    ...
    void 당첨번호_검증_숫자아님_예외처리(String winningLottoNumbers) {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> LottoValidator.validateWinningLottoNumbers(winningLottoNumbers))
