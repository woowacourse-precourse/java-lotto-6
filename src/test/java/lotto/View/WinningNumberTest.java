...
public class WinningNumberTest {
    ...
    public void checkRangeTest() {
        Assertions.assertThatThrownBy(() -> new WinningNumber(List.of(1,2,3,4,5,46))).isInstanceOf(IllegalArgumentException.class);
    ...
    public void checkDuplicateTest() {
        Assertions.assertThatThrownBy(() -> new WinningNumber(List.of(1,1,3,4,5,6))).isInstanceOf(IllegalArgumentException.class);
    }
