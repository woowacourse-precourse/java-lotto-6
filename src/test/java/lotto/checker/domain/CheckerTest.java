...
public class CheckerTest {
    ...
    void 로또_당첨_등수_계산_비당첨() {
        ...
        assertThat(checker.calculateRank(winningNumbers, lottoNumbers)).isEqualTo(6);
    }
    ...
    void 로또_당첨_등수_계산_오등() {
        ...
        assertThat(checker.calculateRank(winningNumbers, lottoNumbers)).isEqualTo(5);
    }
    ...
    void 로또_당첨_등수_계산_사등() {
        ...
        assertThat(checker.calculateRank(winningNumbers, lottoNumbers)).isEqualTo(4);
    }
    ...
    void 로또_당첨_등수_계산_삼등() {
        ...
        assertThat(checker.calculateRank(winningNumbers, lottoNumbers)).isEqualTo(3);
    }
    ...
    void 로또_당첨_등수_계산_보너스() {
        ...
        assertThat(checker.calculateRank(winningNumbers, lottoNumbers)).isEqualTo(2);
    }
    ...
    void 로또_당첨_등수_계산_일등() {
        ...
        assertThat(checker.calculateRank(winningNumbers, lottoNumbers)).isEqualTo(1);
    }
