...
class LottoStoreMessageTest {
    ...
    void get으로_메시지얻을수있다() {
        ...
        String actual = LottosMessage.EXCEPTION_INDIVISIBLE.get();
    ...
    void makeMessageForIndivisible로_단위불가분_경고메시지획득할수있다() {
        ...
        String actual = LottosMessage.makeMessageForIndivisible(50);
    ...
    void makeMessageForOutOfRange_단위벗어남_경고메시지획득할수있다() {
        ...
        String actual = LottosMessage.makeMessageForOutOfRange(10, 500);
