...
public class InputValidatorTest {
    ...
    void 구입_금액_validateInputTest(String budget) {
    ...
    void 구입_금액_validateIntegerExceptionTest(String budget) {
        InputValidator inputValidator = new InputValidator();
    ...
    void 구입_금액_validatePositiveIntegerExceptionTest(String budget) {
        InputValidator inputValidator = new InputValidator();
        assertThatThrownBy(() -> inputValidator.validateBudgetInput(budget))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void 구입_금액_validateDividedBy1000ExceptionTest(String budget) {
        InputValidator inputValidator = new InputValidator();
        assertThatThrownBy(() -> inputValidator.validateBudgetInput(budget))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void 당첨_번호_validateInputTest(String lottoTicket) {
        InputValidator inputValidator = new InputValidator();
    ...
    void 당첨_번호_validateIntegerExceptionTest(String lottoTicket) {
        InputValidator inputValidator = new InputValidator();
    ...
    void 당첨_번호_validateNumberInRangeExceptionTest(String lottoTicket) {
        InputValidator inputValidator = new InputValidator();
        assertThatThrownBy(() -> inputValidator.validateLottoTicketInput(lottoTicket)).isInstanceOf(
                IllegalArgumentException.class);
    }
    ...
    void 당첨_번호_validateDuplicationExceptionTest(String lottoTicket) {
        InputValidator inputValidator = new InputValidator();
        assertThatThrownBy(() -> inputValidator.validateLottoTicketInput(lottoTicket)).isInstanceOf(
                IllegalArgumentException.class);
    }
