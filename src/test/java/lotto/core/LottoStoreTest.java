...
class LottoStoreTest {
    ...
    void exceptionSituation1_1() {
        ...
        String output = outContent.toString();
        assertThat(output).contains("[ERROR] 최소단위는 1,000원이며 2,147,483,000원 까지 입력 가능합니다.");
    }
    ...
    void exceptionSituation1_2() {
        ...
        String output = outContent.toString();
        assertThat(output).contains("[ERROR] 반드시 숫자만 입력하셔야 합니다.");
    }
    ...
    void exceptionSituation1_3() {
        ...
        String output = outContent.toString();
        assertThat(output).contains("[ERROR] 수의 범위를 벗어났습니다. 다시 입력해 주세요.");
    }
    ...
    void exceptionSituation2_1() {
        ...
        String output = outContent.toString();
        assertThat(output).contains("[ERROR] 로또 번호는 6자리 입니다.");
    }
    ...
    void exceptionSituation2_4() {
        ...
        String output = outContent.toString();
        assertThat(output).contains("[ERROR] 번호는 중복되지 말아야 합니다.");
    }
    ...
    void exceptionSituation2_5() {
        ...
        String output = outContent.toString();
        assertThat(output).contains("[ERROR] 번호의 값은 1 ~ 45 사이의 정수 입니다.");
    }
