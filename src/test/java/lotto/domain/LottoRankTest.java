...
import lotto.service.CheckWinningLottoNumbersService;
...
public class LottoRankTest {
	...
	@ParameterizedTest
	void test(int matchedNumCount, boolean isBonusNumber, int expect) {
		CheckWinningLottoNumbersService service = new CheckWinningLottoNumbersService();
