...
public class LottosTest {
    ...
    void 로또_결과_리스트_반환_테스트(WinningNumber winning, BonusNumber bonus, List<LottoResults> expected) {
        //given
