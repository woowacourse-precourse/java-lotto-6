...
class LottosTest {
    ...
    void Lottos_는_순서를_보장한다() {
        ...
        assertThat(lottos.lottoGroup().get(0).toString()).isEqualTo("""
                [1, 2, 3, 4, 5, 6]""");
        assertThat(lottos.lottoGroup().get(1).toString()).isEqualTo("""
                [1, 2, 5, 7, 8, 9]""");
    }
    ...
    void lottos_동등성_비교() {
        ...
        assertThat(tempLottos).isEqualTo(lottos);
    }
    ...
    void lottos_동일성_비교() {
        ...
        assertThat(tempLottos).isNotSameAs(lottos);
    }
