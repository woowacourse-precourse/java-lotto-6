...
class NumericStringTest {
    ...
    public void createByNonNumeric(String money) {
        assertThatThrownBy(() -> new NumericString(money)).isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    @DisplayName("빈값 입력시 예외")
    public void createByEmptyString() {
        assertThatThrownBy(() -> new NumericString("")).isInstanceOf(IllegalArgumentException.class);
    }
