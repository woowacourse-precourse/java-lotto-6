...
class WinnerLottoTest {
    ...
    void createWinnerLottoWithWrongNumberSizeExceptionTest(List<Integer> winnerNumbers, Integer bonusNumber) {
    ...
    void createWinnerLottoWithDuplicatedNumberInNumbersExceptionTest(List<Integer> winnerNumbers, Integer bonusNumber) {
        assertThatThrownBy(() -> WinnerLotto.create(winnerNumbers, bonusNumber))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void createWinnerLottoWithDuplicatedNumberBetweenNumbersAndBonusNumberExceptionTest(List<Integer> winnerNumbers, Integer bonusNumber) {
        assertThatThrownBy(() -> WinnerLotto.create(winnerNumbers, bonusNumber))
                .isInstanceOf(IllegalArgumentException.class);
    }
