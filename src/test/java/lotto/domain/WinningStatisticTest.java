...
class WinningStatisticTest {
    ...
    void calculateYield() {
        WinningStatistic winningStatistic = new WinningStatistic();
        winningStatistic.addRank(Rank.FIRST); // 2,000,000,000원
        winningStatistic.addRank(Rank.SECOND); // 30,000,000원
        winningStatistic.addRank(Rank.THIRD); // 1,500,000원
        winningStatistic.addRank(Rank.MISS); // 0원
        winningStatistic.addRank(Rank.MISS); // 0원
