...
class LottosTest {
    ...
    private static Stream<Arguments> argumentsExpectedWinningResult() {
        ...
        Lotto sixNumbersMatchedLotto = new Lotto(createLottoNumbers(List.of(1, 2, 3, 4, 5, 6)));
        Lotto fiveNumbersAndBonusNumberMatchedLotto = new Lotto(
                createLottoNumbers(List.of(1, 2, 3, 4, 5, 7)));
        Lotto fiveNumbersMatchedLotto = new Lotto(createLottoNumbers(List.of(1, 2, 3, 4, 5, 8)));
        Lotto fourNumbersMatchedLotto = new Lotto(createLottoNumbers(List.of(1, 2, 3, 4, 7, 8)));
        Lotto threeNumbersMatchedLotto = new Lotto(createLottoNumbers(List.of(1, 2, 3, 7, 8, 9)));
        Lotto nothingMatchedLotto = new Lotto(createLottoNumbers(List.of(10, 11, 12, 13, 14, 15)));
