...
public class BonusTest {
    ...
    public void testValidBonusInitialization() {
        ...
        Bonus validBonus = new Bonus("35", winningLottoNumbers);
    ...
    public void testInvalidBonusInitialization() {
        ...
        IllegalArgumentException invalidNumberException = assertThrows(IllegalArgumentException.class, () -> new Bonus("abc", winningLottoNumbers));
        assertEquals(Messages.LOTTO_STATE_ERROR_MESSAGE, invalidNumberException.getMessage());

        // Number out of range
        IllegalArgumentException outOfRangeException = assertThrows(IllegalArgumentException.class, () -> new Bonus("60", winningLottoNumbers));
        assertEquals(Messages.LOTTO_NUMBER_OUT_OF_RANGE_ERROR_MESSAGE, outOfRangeException.getMessage());

        // Duplicate number
        IllegalArgumentException duplicateException = assertThrows(IllegalArgumentException.class, () -> new Bonus("30", winningLottoNumbers));
