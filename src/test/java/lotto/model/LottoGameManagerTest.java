...
class LottoGameManagerTest {
    ...
    void of() {
        ...
        // when
        LottoGameManager result = LottoGameManager.createGameManager(lottoOwner, winningLotto);
    ...
    private LottoOwner getLottoOwner() {
        PurchasePrice purchasePrice = PurchasePrice.createPurchase(1000);
    ...
    private WinningLotto getWinningLotto(List<Integer> winningNumbers) {
        return WinningLotto.createWinningLotto(Lotto.createLottoWithNumbers(winningNumbers), 2);
    }
}
