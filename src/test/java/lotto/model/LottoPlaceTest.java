...
class LottoPlaceTest {
    ...
    @CsvSource(value = {"3,false,FIFTH", "4,true,FOURTH", "5,false,THIRD", "5,true,SECOND", "6,false,FIRST"})
    void judgeLottoPlace(int countCorrectNumber, boolean isBonusNumberCorrect, String expected) {
        ...
        Optional<LottoPlace> resultPlace = LottoPlace.
                judgeLottoPlace(new LottoStatus(countCorrectNumber, isBonusNumberCorrect));
