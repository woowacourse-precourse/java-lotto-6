...
class LottoServiceTest {
    private final LottoService lottoService = TestConstants.TEST_LOTTO_CONFIG.lottoService();
    ...
    void getLottoReceipt() {
        ...
        assertThat(lottoReceiptDto.lottos()).contains(new LottoDto(TestConstants.NORMAL_NUMBERS));
    }
    ...
    void givenPurchaseOneAndWinningFirstRank() {
        ...
        lottoService.drawLottoWithoutBonusNumber(TestConstants.NORMAL_NUMBERS);
