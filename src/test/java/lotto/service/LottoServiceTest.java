...
class LottoServiceTest {
    ...
    void oneWinningNumbers() {
        List<Integer> winningNumbers = List.of(11,22,33,42,43,45);
        LottoService lottoService = new LottoService();
        Lotto lotto = new Lotto(List.of(12,25,36,37,38,45));
        int winningCount = lottoService.checkLotto(lotto, winningNumbers);
    ...
    void fourWinningNumbers() {
        List<Integer> winningNumbers = List.of(1,5,12,31,34,45);
        LottoService lottoService = new LottoService();
    ...
    void fiveWinningNumbers() {
        List<Integer> winningNumbers = List.of(1,3,12,21,22,45);
        LottoService lottoService = new LottoService();
    ...
    void allWinningNumbers() {
        List<Integer> winningNumbers = List.of(1,17,20,21,30,42);
        LottoService lottoService = new LottoService();
