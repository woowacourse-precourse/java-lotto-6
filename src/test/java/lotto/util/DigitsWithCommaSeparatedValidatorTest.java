...
class DigitsWithCommaSeparatedValidatorTest {
    @ParameterizedTest
    @ValueSource(strings = {",", "123,", ",123", " ", "", "12a,3", "23 ,45"})
    void validateDigitsWithCommaSeparatedToFail(String input) {
        assertThatThrownBy(() -> DigitsWithCommaSeparatedValidator.validate(input))
    ...
    void validateDigitsWithCommaSeparatedToSuccess(String input) {
        assertDoesNotThrow(() -> DigitsWithCommaSeparatedValidator.validate(input));
    }
}
