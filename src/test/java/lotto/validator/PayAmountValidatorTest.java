...
public class PayAmountValidatorTest {
    ...
    @NullAndEmptySource
    @ValueSource(strings = {" ", "   ", "\t", "\n"})
    void testWhenPurchaseAmountIsNullOrBlank(String payAmount) {
    ...
    void testWhenPurchaseAmountIsNotNumeric(String payAmount) {
        IllegalArgumentException payAmountException =
                Assertions.assertThrows(IllegalArgumentException.class,
                        () -> payAmountValidator.validate(payAmount));
        assertThat(payAmountException.getMessage()).contains("[ERROR]");
    ...
    void testWhenPurchaseAmountCannotDivideOneThousand(String payAmount) {
        IllegalArgumentException payAmountException =
                Assertions.assertThrows(IllegalArgumentException.class,
                        () -> payAmountValidator.validate(payAmount));
        assertThat(payAmountException.getMessage()).contains("[ERROR]");
