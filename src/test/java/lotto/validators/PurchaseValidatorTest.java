...
public class PurchaseValidatorTest {
    @ParameterizedTest
    @CsvSource({"-1000, " + INPUT_PRICE_IS_NOT_GREATER_THAN_ZERO,
    ...
    void validPurchasePrice(Integer purchasePrice, String expectedMessage) {
        assertThatThrownBy(() -> PurchaseValidator.validPurchasePrice(purchasePrice)).isInstanceOf(
                IllegalArgumentException.class).hasMessage(expectedMessage);
    }
}
