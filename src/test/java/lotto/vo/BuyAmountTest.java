...
class BuyAmountTest {
    ...
    void invalid_purchaseAmount_less_than_lotto_price_test(Integer invalidAmount) {
        // then
    ...
    void invalid_purchaseAmount_has_change_test(Integer invalidAmount) {
        // then
        assertThrows(IllegalArgumentException.class, () -> new BuyAmount(invalidAmount));
    }
