...
public class LottoWinningNumbersTest {
    ...
    void LottoWinningNumbersByOutLange() {
        assertThatThrownBy(() -> new LottoWinningNumbers(new Lotto(List.of(0,1,2,3,4,5)), "7"))
    ...
    void LottoWinningNumbersByDuplicationBonusNumber() {
        assertThatThrownBy(() -> new LottoWinningNumbers(new Lotto(List.of(0,1,2,3,4,5)), "5"))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void LottoWinningNumbersByBonusOverLength(){
        assertThatThrownBy(() -> new LottoWinningNumbers( new Lotto(List.of(0,1,2,3,4,5)), "6,8"))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void LottoWinningNumbersByBonusOutRange(){
        assertThatThrownBy(() -> new LottoWinningNumbers(new Lotto(List.of(0,1,2,3,4,5)), "46"))
                .isInstanceOf(IllegalArgumentException.class);
    }
}
